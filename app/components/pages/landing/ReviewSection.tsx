...
export default function ReviewSection() {
  return (
    <section className="py-20 mx-auto relative sm:py-32">
      ...
      <div className="[mask-image:_linear-gradient(to_right,_transparent_0,_#e6e6e6_128px,#e6e6e6_calc(100%-128px),_transparent_100%)] mt-8 flex flex-col gap-2 relative sm:mt-12">
