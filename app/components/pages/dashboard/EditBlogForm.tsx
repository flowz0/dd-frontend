...
export default function EditBlogForm({ initialData }: { initialData: BlogProps }) {
  ...
  return (
    <form onSubmit={handleSubmit} aria-label="Edit Blog Form" className="bg-[#ffffff] shadow shadow-[hsl(0,0%,80%)] mt-8 mx-6 px-6 py-8 max-w-4xl flex flex-col gap-y-6 sm:mt-12 lg:mx-auto rounded-lg lg:px-20 lg:py-20" noValidate>
      <FormInput
        name="title"
        label="Blog title"
        type="text"
