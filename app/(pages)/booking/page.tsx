...
export default function BookingPage() {
  ...
  return (
    <>
      <main className="bg-[#ffffff] text-[#333333] pt-28 pb-32 sm:pt-32">
        <header className="max-w-7xl px-6 mx-auto flex flex-col items-center">
          ...
          <button
            ...
            onClick={handleClick}
            className="flex items-center gap-x-3 mt-8 bg-[#0080DB] text-[#E6E6E6] py-3 px-6 font-semibold rounded-md hover:bg-[hsl(205,100%,33%)] active:bg-[hsl(205,100%,23%)]"
          >
